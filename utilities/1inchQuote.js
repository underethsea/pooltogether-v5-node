...
const apiUrl = 'https://api.1inch.dev/swap/v5.2/10/quote';
...
async function getQuote(srcToken, dstToken, amount) {
...
getQuote('0x395Ae52bB17aef68C2888d941736A71dC6d4e125', '0x4200000000000000000000000000000000000006', 100000000000000);
