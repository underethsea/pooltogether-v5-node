      ...
      if (parseFloat(maxOut) === 0) {
        ...
        try {
          ...
          console.log(
            ...
            " and a profit of ",
            (
              ethers.utils.formatUnits(bestOptionOutPercentage, pairDecimals) *
                pairOutPrice -
              ethers.utils.formatUnits(
...
*/
            ...
            console.log(
              "SWAPPER Gas Estimate through Web3 " +
...
tx = await CONTRACTS.LIQUIDATIONROUTERSIGNER[
          ...
          " L1 Gas fees (in ETH) " + L1transactionCost);

          totalTransactionCost = L2transactionCost + L1transactionCost;
          totalTransasactionCostDollar = totalTransactionCost * ethPrice;
          console.log("Total Gas fees (in ETH) " + totalTransactionCost + "  $" + totalTransasactionCostDollar);
